...
# #
    ...
    print(lis)
    for i in range(1):  ### Implies that we are using just 3 different styles of writing to generate the words
        style = i+1
        ...
        img = Image.new('RGBA',(7000,200),"black") #Creating the required backgroudfor the word
        count = 0
        elem = 0
        l,r = 0,0
        ...
        #print("namaste")
        plt.imsave('wordimgs/word'+str(word_count)+'_'+str(style)+'.png',img,cmap = 'gray')
